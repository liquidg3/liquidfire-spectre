...
I'm going to assume you have created an app using [Sockets](https://github.com/liquidg3/liquidfire-sockets) or [Alfred](https://github.com/hemstreet/Titan-Alfred) or something similar.
